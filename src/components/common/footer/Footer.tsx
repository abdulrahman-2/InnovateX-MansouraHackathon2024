  ...
  return (
    <div className=" mt-20 bg-black">
      <div className=" container grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 py-6">
        ...
        <div>
          <h1 className="font-bold text-xl text-white p-4 py-6">
            وسائل التواصل :{" "}
          </h1>
          <hr className="w-2/3 border-[#DF5829] " />
        ...
        <div>
          ...
          <div className="flex flex-col space-y-2 mt-4">
            <Link href="/" className="text-white text-xl hover:text-[#DF5829] ">
              الرئيسية
            </Link>
            <Link
              href="/about"
              className="text-white text-xl hover:text-[#DF5829] "
            >
              من نحن
            </Link>
            <Link
      ...
      <div className="bg-[#DF5829] p-6 ">
        <p className="text-center text-white text-xl ">
          جميع حقوق محفوظة &copy; InnovateX {year}
        </p>
      </div>
    </div>
  );
